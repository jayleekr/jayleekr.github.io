...
<head>
    <title>Code coverage report for jayleekr.github.io/backup-old-site/assets/js/lib/jquery.disqusloader.min.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">jayleekr.github.io/backup-old-site/assets/js/lib</a> jquery.disqusloader.min.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >  disqusLoader.js v1.0</span>
<span class="cstat-no" title="statement not covered" >  A JavaScript plugin for lazy-loading Disqus comments widget.</span>
<span class="cstat-no" title="statement not covered" >  -</span>
<span class="cstat-no" title="statement not covered" >  By Osvaldas Valutis, www.osvaldas.info</span>
<span class="cstat-no" title="statement not covered" >  Available for use under the MIT License</span>
<span class="cstat-no" title="statement not covered" >*/</span>
<span class="cstat-no" title="statement not covered" >(function(e,g,h,d){var a=e(g),k=function(o,n){var q,p;return function(){var t=this,s=arguments,r=+new Date;q&amp;&amp;r&lt;q+o?(clearTimeout(p),p=setTimeout(function(){q=r,n.apply(t,s)},o)):(q=r,n.apply(t,s))}},m=false,j=false,i=false,c=false,f="unloaded",b=e(),l=function(){if(!b.length||b.data("disqusLoaderStatus")=="loaded"){return true}var n=a.scrollTop();if(b.offset().top-n&gt;a.height()*j||n-b.offset().top-b.outerHeight()-(a.height()*j)&gt;0){return true}e("#disqus_thread").removeAttr("id");b.attr("id","disqus_thread").data("disqusLoaderStatus","loaded");if(f=="loaded"){DISQUS.reset({reload:true,config:i})}else{g.disqus_config=i;if(f=="unloaded"){f="loading";e.ajax({url:c,async:true,cache:true,dataType:"script",success:function(){f="loaded"}})}}};a.on("scroll resize",k(m,l));e.disqusLoader=function(o,n){n=e.extend({},{laziness:1,throttle:250,scriptUrl:false,disqusConfig:false},n);j=n.laziness+1;m=n.throttle;i=n.disqusConfig;c=c===false?n.scriptUrl:c;b=(typeof o=="string"?e(o):o).eq(0);b.data("disqusLoaderStatus","unloaded");l()}})(jQuery,window,document);</span></pre></td></tr></table></pre>
